        ...
        >
          ...
          >
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Link 
                href="/nasil-calisir" 
                className="px-6 py-3 rounded-full border-2 border-orange-500 text-orange-600 hover:bg-orange-500 hover:text-white font-semibold focus:outline-none focus:ring-2 focus:ring-orange-300 transition-all duration-300 flex items-center gap-2"
              >
                <Info size={20} />
